...
public class UpdateInfoService {
	...
	public UpdateInfo getUpDateInfo() throws Exception {
		...
		if (info.split("&").length>= 5 ) {
				...
				updateInfo.setPkgLen(info.split("&")[2]);
			switch (info.split("&")[3].split(";").length) {
				case 0:
					updateInfo.setDescription(info.split("&")[3]);
					break;
				case 1:
					updateInfo.setDescription(info.split("&")[3].split(";")[0]);
					break;
				case 2:
					updateInfo.setDescription(info.split("&")[3].split(";")[0] + "\n" + info.split("&")[3].split(";")[1]);
					break;
				case 3:
					updateInfo.setDescription(info.split("&")[3].split(";")[0] + "\n" + info.split("&")[3].split(";")[1] + "\n" + info.split("&")[3].split(";")[2]);
					break;
				}
				updateInfo.setUrl(info.split("&")[4]);
