...
/**
 * Created by dysen_000 on 2016-06-30 16:59.
 * Email：dysen@outlook.com
 * Info：
 */
public class MyColorArcProgressBar extends View{
    ...
    public MyColorArcProgressBar(Context context) {
        super(context, null);
        initView();
    }

    public MyColorArcProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        initCofig(context, attrs);
        initView();
    }

    public MyColorArcProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
