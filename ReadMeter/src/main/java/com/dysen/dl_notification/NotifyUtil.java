...
//                requestCode, intent, FLAG);
    ...
    public void notify_normail_moreline(PendingIntent pendingIntent, int smallIcon, String ticker,
        ...
        if (sdk < Build.VERSION_CODES.JELLY_BEAN) {
            ...
            ToastUtils.showLong(mContext, "您的手机低于Android 4.1.2，不支持多行通知显示！！", 3);
        } else {
    ...
    public void notify_progress(PendingIntent pendingIntent, int smallIcon,
        ...
        fh.download(download_url,  savePath, new AjaxCallBack<File>() {
            @Override
            public void onLoading(long count, long current) {
                ...
                System.out.println((int)currentPro+"%");
            ...
            public void onFailure(Throwable t, String strMsg) {
                ...
                System.out.println(t+"失败"+"\n"+strMsg);
                listener.onFailure(t,strMsg);
            }
        });

        KJHttp http = new KJHttp();
//        http.download(savePath, download_url, new HttpCallBack<File>() {
//
//            @Override
//            public void onLoading(long count, long current) {
//                super.onLoading(count, current);
